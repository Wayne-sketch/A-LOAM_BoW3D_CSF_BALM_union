...
CSF::CSF()
{
	params.bSloopSmooth = false;
	params.time_step = 0.95;// 0.95 for rs
	params.class_threshold = 0.5;
	params.cloth_resolution = 3.0;// 3.0 for rs
	params.rigidness = 3;
	params.iterations = 600;// 600 for rs
	this->index = 0;
}
...
void CSF::setPointCloud(pcl::PointCloud<pcl::PointXYZI>& points)
{
...
Cloth CSF::do_cloth() {
    ...
    */
    ...
    // boost::progress_display pd(params.iterations);
